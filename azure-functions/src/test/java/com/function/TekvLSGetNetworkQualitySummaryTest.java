...
public class TekvLSGetNetworkQualitySummaryTest extends TekvLSTest {

    private final TekvLSGetNetworkQualitySummary getNetworkQualitySummary = new TekvLSGetNetworkQualitySummary();
    ...
    public void getNetworkQualitySummaryWithUsersAndRegionsTest() {
        ...
        HttpResponseMessage response = getNetworkQualitySummary.run(this.request, this.context);
    ...
    public void sqlExceptionTest() {
        ...
        try {
            response = new EnvironmentVariables("POSTGRESQL_SERVER", "test").execute(
                    () -> getNetworkQualitySummary.run(this.request, this.context));
        } catch (Exception e) {
