...
class TekvLSGetAllLicenseUsageDetailsTest extends TekvLSTest {
    ...
    @Tag("Security")
    @Test
    public void getLicenseUsageDetailNoTokenTest(){
        //Given
    ...
    @Tag("Security")
    @Test
    public void getLicenseUsageDetailInvalidRoleTest(){
        //Given
    ...
    @Test
    public void getLicenseUsageInvalidIdTest(){
        //Given
    ...
    @Test
    public void getLicenseUsageGenericExceptionTest(){
        //Given
        String subaccountId = "01442bce-d452-4742-bcb5-27b93a44314f";
        this.queryParams.put("subaccountId",subaccountId);
