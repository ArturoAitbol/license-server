...
public class TekvLSGetFilterOptionsTest extends TekvLSTest {
    private final TekvLSGetFilterOptions getFilterOptionsTest = new TekvLSGetFilterOptions();
    ...
    @Tag("acceptance")
    @Test
    public void getFilterOptionsTest() {
        ...
        HttpResponseMessage response = getFilterOptionsTest.run(this.request, this.context);
    ...
    @Tag("acceptance")
    @Test
    public void getFilterOptionsWithoutRegionsTest() {
        String subaccountId = "f5a609c0-8b70-4a10-9dc8-9536bdb5652c";
        String startDate = "2023-07-03 00:00:00";
        String endDate = "2023-07-03 19:48:29";
        String users = "2142428813";
