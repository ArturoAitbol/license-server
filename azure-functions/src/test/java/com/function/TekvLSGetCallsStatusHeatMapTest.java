...
public class TekvLSGetCallsStatusHeatMapTest extends TekvLSTest {

    private final TekvLSGetCallsStatusHeatMap getCallsStatusHeatMap = new TekvLSGetCallsStatusHeatMap();
    ...
    @Tag("acceptance")
    @Test
    public void getGetCallsStatusHeatMapWithUsersAndRegionsTest() {
        ...
        HttpResponseMessage response = getCallsStatusHeatMap.run(this.request, this.context);
    ...
    public void sqlExceptionTest() {
        ...
        try {
            response = new EnvironmentVariables("POSTGRESQL_SERVER", "test").execute(
                    () -> getCallsStatusHeatMap.run(this.request, this.context));
        } catch (Exception e) {
