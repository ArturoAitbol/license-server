...
public class TekvLSGetCallsStatusSummaryTest extends TekvLSTest {

    private final TekvLSGetCallsStatusSummary getCallsStatusSummary = new TekvLSGetCallsStatusSummary();
    ...
    @Tag("acceptance")
    @Test
    public void getCallStatusSummaryWithUsersAndRegionsTest() {
        ...
        HttpResponseMessage response = getCallsStatusSummary.run(this.request, this.context);
    ...
    @Test
    public void getCallStatusSummaryTest() {
        String subaccountId = "f5a609c0-8b70-4a10-9dc8-9536bdb5652c";
        String startDate = "2023-06-24 00:00:00";
        String endDate = "2023-06-30 19:48:29";
        this.queryParams.put("subaccountId",subaccountId);
    ...
    public void sqlExceptionTest() {
        ...
        try {
            response = new EnvironmentVariables("POSTGRESQL_SERVER", "test").execute(
                    () -> getCallsStatusSummary.run(this.request, this.context));
        } catch (Exception e) {
