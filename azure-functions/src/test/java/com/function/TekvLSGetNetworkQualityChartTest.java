...
public class TekvLSGetNetworkQualityChartTest extends TekvLSTest {

    private final TekvLSGetNetworkQualityChart getNetworkQualityChart = new TekvLSGetNetworkQualityChart();
    ...
    @Tag("acceptance")
    @Test
    public void getNetworkQualityChartWithUsersAndRegionsTest() {
        ...
        String metric = "Received Jitter,Received packet loss,Round trip time,Sent bitrate";
        String groupBy = "hour";
        ...
        this.queryParams.put("groupBy", groupBy);
        this.queryParams.put("regions",regions);
        this.queryParams.put("users",users);
        HttpResponseMessage response = getNetworkQualityChart.run(this.request, this.context);
    ...
    @Tag("acceptance")
    @Test
    public void getNetworkQualityChartWithPOLQATest() {
        String subaccountId = "f5a609c0-8b70-4a10-9dc8-9536bdb5652c";
        String regions = "[{\"country\":\"United States\",\"state\":\"FL\",\"city\":Tampa}]";
        String startDate = "2023-07-03 00:00:00";
        String endDate = "2023-07-03 19:48:29";
        String users = "2142428813";
        String metric = "POLQA,Received Jitter,Received packet loss,Round trip time,Sent bitrate";
        String groupBy = "day";
        String callsFilter = "POLQA";
        this.queryParams.put("subaccountId",subaccountId);
        this.queryParams.put("startDate", startDate);
        this.queryParams.put("endDate", endDate);
        this.queryParams.put("metric", metric);
        ...
        this.queryParams.put("regions",regions);
        this.queryParams.put("users",users);
        this.queryParams.put("callsFilter",callsFilter);
        HttpResponseMessage response = getNetworkQualityChart.run(this.request, this.context);
        this.context.getLogger().info(response.getBody().toString());
    ...
    public void sqlExceptionTest() {
        ...
        try {
            response = new EnvironmentVariables("POSTGRESQL_SERVER", "test").execute(
                    () -> getNetworkQualityChart.run(this.request, this.context));
        } catch (Exception e) {
