...
public class TekvLSModifyCtaasOnBoardingByIdTest extends TekvLSTest {
    private final TekvLSModifyCtaasOnBoardingById tekvLSModifyCtaasOnBoardingById = new TekvLSModifyCtaasOnBoardingById();
    ...
    public void modifyCtaasOnBoarding(){
        ...
        //When
        HttpResponseMessage response = tekvLSModifyCtaasOnBoardingById.run(this.request,this.ctaasSetupId,this.context);
        this.context.getLogger().info(response.getStatus().toString());
    ...
    public void invalidSQLTest(){
        ...
        //When
        HttpResponseMessage response = tekvLSModifyCtaasOnBoardingById.run(this.request,invalidId,this.context);
        this.context.getLogger().info(response.getBody().toString());
