...
public class GraphAPIServiceClient {
	...
	public static void updateUserProfile(String id, String displayName, String jobTitle, String companyName, String mobilePhone, ExecutionContext context)  throws Exception {
