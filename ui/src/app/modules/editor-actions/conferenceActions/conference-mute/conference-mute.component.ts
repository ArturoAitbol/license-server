...
@Component({
    selector: 'app-conference-mute',
    templateUrl: './conference-mute.component.html',
    styleUrls: ['./conference-mute.component.css']
})
export class ConferenceMuteComponent implements OnInit, OnDestroy {
    action: any;
    ...
    callMuteType: string[] = ['mute', 'unmute', 'invert'];
    actionToEdit: any = {};
    resourcesBk: any;
    ...
    ngOnInit() {
        this.selectedCallType = this.callMuteType[2];
    ...
    createAction() {
        ...
        let query = `${this.selectedConversation}.${this.selectedResource}.conferenceMute(type='${this.selectedCallType}'`;
