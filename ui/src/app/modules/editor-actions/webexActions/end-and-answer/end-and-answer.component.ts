...
@Component({
  selector: 'app-end-and-answer',
  templateUrl: './end-and-answer.component.html',
  styleUrls: ['./end-and-answer.component.css']
})
export class EndAndAnswerComponent implements OnInit, OnDestroy {
  action: any;
  ...
  createAction() {
    const item = {
      action: 'end_and_answer',
      phone: this.selectedDevice,
      conversationName: this.selectedConversation,
      continueonfailure: this.continueOnFailure
    };
    // tslint:disable-next-line: max-line-length
    let query = this.selectedConversation + '.' + this.selectedDevice + '.endAndAnswer(';
