export enum ReportType {
    ...
    // DAILY_VQ = 'Daily-VQ',  // as media injection is not ready yet, hence disabling VQ as of now
    WEEKLY_FEATURE_FUNCTIONALITY = 'Weekly-FeatureFunctionality',
    // WEEKLY_CALLING_RELIABILITY = 'Weekly-CallingReliability',
    // WEEKLY_VQ = 'Weekly-VQ'  // as media injection is not ready yet, hence disabling VQ as of now
}